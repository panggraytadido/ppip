<?php
$this->pageTitle = "Form Set Stock - Gudang";
        		...
        		'clientOptions'=>array(
                      ...
                      <input type="hidden" name="barangid" id="barangid" value="<?php echo $barangid; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input class="form-control" disabled="disabled" value="<?php echo strtoupper(Lokasipenyimpananbarang::model()->findByPk(Yii::app()->session['lokasiid'])->nama); ?>">
                            </div>
                        </div>
                        <?php 
