...
<?php $this->widget('booster.widgets.TbGridView', array(
	'id'=>'gudangpemindahanbarang-grid',
		...
		array('name'=>'nama','value'=>'$data->nama','header'=>'Nama Barang'),
                array('name'=>'tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal Pemindahan',
                        'filter'=>  $this->widget(
                            ...
                            array(
                                'name' => 'Gudangpemindahanbarang[tanggal]',
                                'attribute' => 'tanggal',
                                'htmlOptions' => array(
                ...
                array('name'=>'jumlah','value'=>'$data->jumlah','header'=>'Jumlah',
                        'filter'=>CHtml::textField('Gudangpemindahanbarang[jumlah]','',array(
                                'id' => 'Gudangpemindahanbarang_jumlah_index',
                                'class' => 'form-control',
                            ))
                ),
                array(
                    ...
                    'template'=>'{view} {update}',
                                    'buttons' => array(
                                        'view' =>   array(
                                                       ...
                                                       'url'=>'Yii::app()->createUrl("gudang/pemindahanbarang/view", array("id"=>$data->id))',
                                                        'options'=>array(
                                        ...
                                        'update' =>   array(
                                                       'label'=>'edit',
                                                       'icon'=>'fa fa-edit',
                                                       'url'=>'Yii::app()->createUrl("gudang/pemindahanbarang/update", array("id"=>$data->id))',
                                                        'options'=>array(
                                                            'class'=>'btn btn-success btn-xs',
                                                            'ajax'=>array(                         
...
function reinstallDatePicker(id, data) {
    $('#Gudangpemindahanbarang_tanggal').datepicker();
}
");
?>
