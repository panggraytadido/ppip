<?php   
        $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
                'type'=>'horizontal',
                'id'=>'gudangpemindahanbarang-form',
...
<input type="hidden" id="Gudangpemindahanbarang_id" name="Gudangpemindahanbarang[id]" value="<?php echo $modelPemindahan->id; ?>" />
        ...
        <?php 
            echo $form->datePickerGroup($modelPemindahan, 'tanggal', array(
                                ...
                                'widgetOptions' => array(
                                                        'htmlOptions'=>array(
                                                                'id'=>'Gudangpemindahanbarang_tanggal_input',
                                                                'readonly'=>'readonly',
        ...
        <input type="hidden" id="Gudangpemindahanbarang_barangid" name="Gudangpemindahanbarang[barangid]" value="<?php echo $modelPemindahan->barangid; ?>" />
        <?php   
                echo $form->dropDownListGroup($modelPemindahan, 'barangid',array(
                                    ...
                                    'widgetOptions' => array(
                                            ...
                                            'htmlOptions' => array(
                                                    ...
                                                    'disabled'=>'disabled',
                                                    'name'=>'Gudangpemindahanbarang_barangid_view',
                                            )
                                    )
                                )
                            );
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <button type="button" onclick="cekJumlahAbsen();" class="btn btn-success"><li class="fa fa-plus"></li></button> 
                    ...
                    <div class="col-sm-4">
                        <?php 
                                echo CHtml::dropDownList('karyawanid[]', $modelBongkarmuat[$i]->karyawanid, 
                                                CHtml::listData(Karyawan::model()->with('absensi')->findAll("jabatanid=11 and tanggal::text like '".date("Y-m-d", strtotime($modelPemindahan->tanggal))."%' and jammasuk is not null"),'id','nama'),
        ...
        <div id="inputKaryawan_<?php echo count($modelBongkarmuat); ?>"></div>
            ...
            array(
                ...
                'success'=>'js:function(data) 
                 {    
                   ...
                   if(data.result==="OK")
                   {  
                        location.href="'.Yii::app()->createUrl("gudang/pemindahanbarang/view", array("id"=>$modelPemindahan->id)).'";
                        selesai();
                   }
                   else
                   {                        
                       ...
                       {
                           $("#gudangpemindahanbarang-form #"+key+"_em_").text(val);                                                    
                           $("#gudangpemindahanbarang-form #"+key+"_em_").show();
                       });
                   }       
...
<script type="text/javascript">
    ...
    {
        var tgl = document.getElementById("Gudangpemindahanbarang_tanggal_input").value;
        var jumlahAbsen = 0;
        ...
        if(tgl!='')
        {
            $.ajax({
                    type: 'POST',
                    url: '<?php echo Yii::app()->baseurl; ?>/gudang/pemindahanbarang/getjumlahabsen',
                    data: { tanggal : tgl},
    ...
    function tambahKaryawan()
    {
        ...
        if(tgl!='')
        {
            $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: '<?php echo Yii::app()->baseurl; ?>/gudang/pemindahanbarang/getkaryawanabsen',
                    data: { tanggal : tgl},
    ...
    {
        var e = document.getElementById("Gudangpemindahanbarang_barangid");
        ...
        if(barangid!='')
        {
            $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: '<?php echo Yii::app()->baseurl; ?>/gudang/pemindahanbarang/getsupplierbarang',
    ...
    function hitungJumlahTotal()
    {
        ...
        document.getElementById("totalJumlah").value = parseInt(total);
