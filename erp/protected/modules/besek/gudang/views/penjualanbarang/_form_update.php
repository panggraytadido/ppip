                    ...
                    <div class="col-sm-4">
                        <?php 
                           ...
                           /* echo CHtml::dropDownList('karyawanid[]', $modelBongkarmuat[$i]->karyawanid, 
                                            CHtml::listData(Karyawan::model()->with('absensi')->findAll("jabatanid=11 and cast(tanggal as date)='".date("Y-m-d", strtotime($modelPenjualan->tanggal))."' and jammasuk is not null"),'id','nama'),
