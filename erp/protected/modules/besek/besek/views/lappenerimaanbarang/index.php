...
$this->pageTitle = "Laporan Penerimaan Barang - Besek";
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                 <div class="ibox-title">
                    <div class="pull-left">
                        <b>Besek - Laporan Penerimaan Barang</b>
                    </div>                   
                </div>
        ...
        ?>
        <div style="display:none" id="Lappenerimaanbarangbesek_pilih_em_" class="help-block error"></div>
             ...
             array(
                 ...
                 'success'=>'js:function(data) 
                  {                                              
                    if(data.result==="OK")
                    {             
                        //location.href="'.Yii::app()->baseurl.'/besek/lappenerimaanbarang/print/pilihan/" + data.pilihan+"/status/" +data.status    	             			             			             			             			             			             
						window.open("'.Yii::app()->baseurl.'/besek/lappenerimaanbarang/print/pilihan/" + data.pilihan+"/status/" +data.status  , "_blank");  
                    }                  
                    else
                    {                        
