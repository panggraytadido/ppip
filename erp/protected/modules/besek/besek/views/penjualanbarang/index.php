<?php
$this->pageTitle = "Penjualan Barang - Besek";
	...
	'columns'=>array(
		array(
                ...
                array('name'=>'tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal Penjualan',
                        'filter'=>  $this->widget(
                            ...
                            array(
                                'name' => 'Besekpenjualanbarang[tanggal]',
                                'attribute' => 'tanggal',
                                'htmlOptions' => array(
		...
		array('name'=>'nama','value'=>'$data->nama','header'=>'Nama Barang'),
                ...
                array('name'=>'jumlah','value'=>'$data->jumlah','header'=>'Jumlah',
                        'filter' => CHtml::textField('Besekpenjualanbarang[jumlah]','',array(
                    ...
                    'template'=>'{view} {update} {delete}',
                                    'buttons' => array(
                                        'view' =>   array(
                                                       ...
                                                       'url'=>'Yii::app()->createUrl("besek/penjualanbarang/view", array("id"=>$data->id))',
                                                        'options'=>array(
                                        ...
                                        'update' =>   array(
                                                       'label'=>'edit',
                                                       'icon'=>'fa fa-edit',
                                                       'url'=>'Yii::app()->createUrl("besek/penjualanbarang/update", array("id"=>$data->id))',
                                                        'options'=>array(
                                                            'class'=>'btn btn-success btn-xs',
                                                            'ajax'=>array(                                                                                    
                                                                'type'=>'POST',
