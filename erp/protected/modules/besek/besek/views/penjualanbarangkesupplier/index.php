<?php
$this->pageTitle = "Penjualan Barang ke Supplier - Besek";
        ...
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="pull-left">
                        <b>Besek - Penjualan Barang ke Supplier</b>
                    </div>
	...
	'columns'=>array(
		array(
                ...
                array('name'=>'tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal Penjualan',
                        'filter'=>  $this->widget(
                            ...
                            array(
                                'name' => 'Besekpenjualanbarangkesupplier[tanggal]',
                                'attribute' => 'tanggal',
                                'htmlOptions' => array(
                                                    'id' => 'Besekpenjualanbarang_tanggal_index',
		...
		array('name'=>'nama','value'=>'$data->nama','header'=>'Nama Barang'),
                ...
                array('name'=>'jumlah','value'=>'$data->jumlah','header'=>'Jumlah',
                        'filter' => CHtml::textField('Besekpenjualanbarangkesupplier[jumlah]','',array(
                            'id' => 'Besekpenjualanbarang_jumlah_index',
                            'class' => 'form-control',
                        )),
                    ...
                    'template'=>'{view} {update} {delete}',
                                    'buttons' => array(
                                        'view' =>   array(
                                                       ...
                                                       'url'=>'Yii::app()->createUrl("besek/penjualanbarangkesupplier/view", array("id"=>$data->id))',
                                                        'options'=>array(
                                        ...
                                        'update' =>   array(
                                                       'label'=>'edit',
                                                       'icon'=>'fa fa-edit',
                                                       'url'=>'Yii::app()->createUrl("besek/penjualanbarangkesupplier/update", array("id"=>$data->id))',
                                                        'options'=>array(
                                                            'class'=>'btn btn-success btn-xs',
                                                            'ajax'=>array(                                                                                    
                                                                'type'=>'POST',
...
function reinstallDatePicker(id, data) {
    $('#Besekpenjualanbarang_tanggal_index').datepicker();
}
");
?>
