...
class StockupdateController extends Controller
{
	public $layout='//layouts/column2';
        public $pageTitle = 'Besek - Stock update';
	...
	public function filters()
	{
        ...
        public function actionDetail()
        {
           ...
           //$stocksupplier = Stocksupplier::model()->findAll('barangid='. $id .' AND lokasipenyimpananbarangid='.Yii::app()->session['lokasiid']);
           ...
           {
               echo CHtml::link('Set Stock n Supplier', array('formsetstock','id'=>$id), array('class'=>'btn btn-warning btn-xs'));
           }           
        }
