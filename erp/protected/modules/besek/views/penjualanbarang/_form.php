...
//                                                    'prompt'=>'Pilih Lokasi',
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="radio" name="Besekpenjualanbarang[kategori]" id="kategori1" onchange="hitungHargaBarang();" value="1" checked="checked" /> R.Ikan 
                <input type="radio" name="Besekpenjualanbarang[kategori]" id="kategori2" onchange="hitungHargaBarang();" value="2" /> Grosir 
            </div>
        </div>
            ...
            array(
                ...
                'success'=>'js:function(data) 
                 {    
                   ...
                   if(data.result==="OK")
                   {             
                      location.href="'.Yii::app()->baseurl.'/besek/penjualanbarang/view/id/" + data.penjualanid;
                   }
