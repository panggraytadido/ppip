<?php
$this->pageTitle = "Form Set Stock dan Supplier - Besek";
        ...
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="pull-left">
                        <b>Besek - Form Set Stock dan Supplier</b>
                    </div>   
                                ...
                                array(
                                    ...
                                    'success'=>'js:function(data) 
                                     {    
                                       ...
                                       if(data.result==="OK")
                                       {             
                                          location.href="'.Yii::app()->baseurl.'/gudang/stockupdate/view/supplierid/" + data.supplierid+"/barangid/" +data.barangid;
                                       }
                                       else
                                       {                        
