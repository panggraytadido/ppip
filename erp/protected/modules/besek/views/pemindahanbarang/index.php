<?php
$this->pageTitle = "Pemindahan Barang - Besek";
		...
		array('name'=>'nama','value'=>'$data->nama','header'=>'Nama Barang'),
                array('name'=>'tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal Pemindahan',
                        'filter'=>  $this->widget(
                            ...
                            array(
                                'name' => 'Besekpemindahanbarang[tanggal]',
                                'attribute' => 'tanggal',
                                'htmlOptions' => array(
                ...
                array('name'=>'jumlah','value'=>'$data->jumlah','header'=>'Jumlah',
                        'filter'=>CHtml::textField('Besekpemindahanbarang[jumlah]','',array(
                                'id' => 'Besekpemindahanbarang_jumlah_index',
                                'class' => 'form-control',
                            ))
                ),
                array(
                    ...
                    'template'=>'{view} {update}',
                                    'buttons' => array(
                                        'view' =>   array(
                                                       ...
                                                       'url'=>'Yii::app()->createUrl("besek/pemindahanbarang/view", array("id"=>$data->id))',
                                                        'options'=>array(
                                        ...
                                        'update' =>   array(
                                                       'label'=>'edit',
                                                       'icon'=>'fa fa-edit',
                                                       'url'=>'Yii::app()->createUrl("besek/pemindahanbarang/update", array("id"=>$data->id))',
                                                        'options'=>array(
                                                            'class'=>'btn btn-success btn-xs',
                                                            'ajax'=>array(                                                                                    
                                                                'type'=>'POST',
...
function reinstallDatePicker(id, data) {
    $('#Besekpemindahanbarang_tanggal').datepicker();
}
");
?>
