...
class RController extends CController
{
	...
	*/
	...
	{
            // == Code hanya untuk PGSQL =============
//            $prefixArr = array("Tlu", "Trx");
//            $id = $filterChain->controller->id;
//            $prefix = ucfirst(substr($id, 0,3));
//            $table = ucfirst(substr($id, 3));            
//            if(in_array($prefix, $prefixArr))
//                parent::__set('id', $prefix.$table);
            // =======================================

//            echo "<pre>";print_r(Yii::app()->getClientScript());die();
//            echo $filterChain->controller->id;die();
//            echo "Ini <pre>";print_r($filterChain);die();
