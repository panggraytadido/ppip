<?php
$this->pageTitle = "Pengeluaran - Keuangan";
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="pull-right">
                        ...
                        <?php 
                            echo CHtml::ajaxButton('Tambah',CHtml::normalizeUrl(array('datapengeluaran/create')),
                                array(
                                    'type'=>'POST',                      
                                    'url'=>"$(this).attr('href')",
                ...
                <div class="ibox-content">
                       <?php $this->widget('booster.widgets.TbGridView', array(
                            ...
                            'dataProvider'=>$model->listPengeluaran(),
                            'filter'=>$model,                            
                            'columns'=>array(
                                    array(
                                        'header'=>'No',
                                    ...
                                    array('name'=>'tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal Kasbon',
                                            'filter'=>  $this->widget(
                                                ...
                                                array(
                                                    'name' => 'Datapengeluaran[tanggal]',
                                                    'attribute' => 'tanggal',
                                                    'htmlOptions' => array(
                                                                        'id' => 'Datapengeluaran_tanggal_index',
                                    ...
                                    array('name'=>'hargasatuan','value'=>'number_format($data->hargasatuan)','header'=>'Harga Satuan'),    
                                     array('name'=>'total','value'=>'number_format($data->total)','header'=>'Total'),    
                                    array(
							                    'header'=>'Action',
							                    ...
							                    'template'=>'{update} {delete}',
							                                    'buttons' => array(
							                                        'update' =>   array(
							                                                       ...
							                                                       'url'=>'Yii::app()->createUrl("keuangan/datapengeluaran/popupupdate", array("id"=>$data->id))', 							                                                       
							                                                        'options'=>array(
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Update Data Pengeluaran</h4>
        </div>
