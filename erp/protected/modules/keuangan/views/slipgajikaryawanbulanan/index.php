            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <?php   $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
                             'action'=>Yii::app()->createAbsoluteUrl("keuangan/slipgajikaryawanbulanan/"),//Yii::app()->createUrl($this->route),
                             //'method'=>'post',
                        ...
                        <div class="col-sm-4">
                            <?php 
                                echo CHtml::dropDownList('jeniskaryawan', '', 
                                                CHtml::listData(Karyawan::model()->findAll('jeniskaryawanid=1'),'id','nama'),
