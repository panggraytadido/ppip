<?php
$this->pageTitle = "Karyawan Harian - Keuangan";
        ...
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="pull-left">
                        <b>Keuangan - Karyawan Harian</b>
                    </div>  

						<div class="pull-right">
                        <a href="" class="btn btn-info btn-xs"><i class="fa fa-refresh"></i> Refresh</a>
                        <?php 
                            echo CHtml::ajaxButton('Tambah',CHtml::normalizeUrl(array('karyawanharian/create')),
                                array(
                                    'type'=>'POST',                      
                                    'url'=>"$(this).attr('href')",
...
$this->widget('booster.widgets.TbGridView', array(
	...
	'dataProvider'=>$model->searchKaryawanharian(),
	'filter'=>$model,
                    ...
                    'template'=>'{update}',
                                    'buttons' => array(                                     
                                        'update' =>   array(
                                                       'label'=>'edit',
                                                       'icon'=>'fa fa-edit',
                                                       'url'=>'Yii::app()->createUrl("keuangan/karyawanharian/popupupdate", array("id"=>$data->id))',
                                                        'options'=>array(
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Tambah Gaji Karyawan Harian</h4>
        </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Update Gaji Karyawan Harian</h4>
        </div>
