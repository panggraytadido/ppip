            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <?php   $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
                             'action'=>Yii::app()->createAbsoluteUrl("keuangan/slipgajikaryawangudang/"),//Yii::app()->createUrl($this->route),
                             //'method'=>'post',
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label required" for="jeniskaryawan">Karyawan</label>
                        <div class="col-sm-4">
                            <?php 
