<?php
$this->pageTitle = "Laporan - Slip Gaji Karyawan Sopir";
...
<script>
    ...
    {      
        ...
        $.ajax({
                dataType: 'json',
                type: 'POST',
                url: '<?php echo Yii::app()->baseurl; ?>/keuangan/slipgajikaryawansopir/checkprint',
                data: data,
                success: function (data) {                                                                          
                 window.open("<?php echo Yii::app()->baseurl ?>/keuangan/slipgajikaryawansopir/print/karyawanid/"+data.karyawanid+"/tahun/"+data.tahun+"/bulan/"+data.bulan);
