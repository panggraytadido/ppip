...
class SlipgajikaryawanbulananController extends Controller
{
	public $layout='//layouts/column2';
        public $pageTitle = 'Keuangan - Slip Gaji Karyawan Bulanan';
	...
	public function filters()
	{
        ...
        public function actionIndex()
        {
            ...
            {       
                ...
                $gajiPerJabatan = Gajiperjabatan::model()->find("jabatanid=".$jabatanId." AND jeniskaryawanid=".$jenisKaryawanId)->gaji;
                $gajiPerJam = $gajiPerJabatan/26/8;
                $totalGaji = $jumlahJam*$gajiPerJam;
                //
        ...
        public function actionCheckPrint()
        {
            if(isset($_POST['karyawanid']) && isset($_POST['tahun']) && isset($_POST['bulan']))
            {
                ...
                $bulan = $_POST['bulan'];
                try{
                    $model = Gajikaryawanbulanan::model()->find("tahun=".$_POST['tahun']." AND bulan='$bulan' AND karyawanid=".$_POST['karyawanid']);                     
                    if(count($model)!=0)
                    {
        ...
        public function actionPrint(/*$karyawanid,$tahun,$bulan*/)
        {
			...
			/*
            echo Yii::app()->Report->Export("gajikaryawanbulanan.jrxml","Gaji Pegawai Bulanan",array(
        ...
        {
            if(isset($_POST['ajax']) && $_POST['ajax']==='slipgajikaryawanbulanan-form')
            {
