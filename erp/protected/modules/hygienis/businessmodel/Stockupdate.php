...
{       
        ...
        public function searchStockupdate()
	{
		$criteria=new CDbCriteria;
                ...
                $criteria->select = 'kode, b.nama, l.nama as namalokasi, jumlah,b.id as id';
                $criteria->alias = 's';
                ...
                {
                    $criteria->compare('kode',$_GET['Stockupdate']['kode'],true);
                    $criteria->compare('b.nama',$_GET['Stockupdate']['nama'],true);
                    $criteria->compare('l.nama',$_GET['Stockupdate']['namalokasi'],true);
                }
        ...
        {
            $sql ="select distinct supplierid,jumlah,supplierid||'-'||barangid as id from transaksi.stocksupplier
