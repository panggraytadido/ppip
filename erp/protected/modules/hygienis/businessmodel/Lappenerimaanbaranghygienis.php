...
class Lappenerimaanbaranghygienis extends Penerimaanbarang
{
        public $pilih;
	public $tanggal;
	public $bulan;
        ...
        public static function model($className=__CLASS__)
	{
        ...
        public function getPenerimaanBarangPerTanggal($tanggal)
        {
            ...
            $sql="SELECT 
                    s.namaperusahaan as supplier,b.nama as barang,pb.jumlah,cast(pb.tanggal as date) as tanggal,hb.hargamodal,pb.jumlah*hb.hargamodal as totalharga
                  FROM 
                  ...
                  WHERE 
                    ...
                    cast(pb.tanggal as date)='$tanggal' and pb.divisiid=$divisiid and pb.lokasipenyimpananbarangid=".Yii::app()->session['lokasiid'];					
        ...
        public function getPenerimaanBarangPerBulan($bulan)
        {
            ...
            $sql="SELECT 
                  ...
                  WHERE 
                    ...
                    pb.supplierid = hb.supplierid AND
                    b.id=hb.barangid AND 
                    EXTRACT(MONTH FROM pb.tanggal)='$bulan' and EXTRACT(YEAR FROM pb.tanggal)='$currYear' and pb.lokasipenyimpananbarangid=".Yii::app()->session['lokasiid'];					
            $data=$connection->createCommand($sql)->queryAll();
            return $data;
        }
