<?php
$this->pageTitle = "Form Set Stock dan Supplier - Hygienis";

$this->breadcrumbs=array(
	'Hygienis',
        'Form Set Stock dan Supplier',
);
        ...
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="pull-left">
                        <b>Hygienis - Form Set Stock dan Supplier</b>
                    </div>   
               ...
               // 'action'=>Yii::app()->createAbsoluteUrl("oemmkt/manajemencustomer/Ajaxvalidatecustomerprofile"),//Yii::app()->createUrl($this->route),
        		...
        		'clientOptions'=>array(
                      ...
                      <input type="hidden" name="barangid" id="barangid" value="<?php echo $barangid; ?>" >
                        ...
                        <?php
                                    echo $form->dropDownListGroup($model, 'supplierid',array(
                      ...
                      <?php 
                            echo CHtml::ajaxSubmitButton('Simpan',CHtml::normalizeUrl(array('stockupdate/setsupplierstockawal','barangid'=>$barangid)),
                                array(
                                    'dataType'=>'json',
                                    'type'=>'POST',                      
                                    'success'=>'js:function(data) 
                                     {    
                                       ...
                                       if(data.result==="OK")
                                       {             
                                          location.href="'.Yii::app()->baseurl.'/hygienis/stockupdate/view/supplierid/" + data.supplierid+"/barangid/" +data.barangid;
                                       }
                                       else
                                       {                        
