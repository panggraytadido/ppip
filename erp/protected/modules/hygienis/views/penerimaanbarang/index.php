	...
	'columns'=>array(
		...
		array('name'=>'nama','value'=>'$data->nama','header'=>'Nama Barang'),
                ...
                array('name'=>'jumlah','value'=>'$data->jumlah','header'=>'Jumlah',
                        'filter' => CHtml::textField('Hygienispenerimaanbarang[jumlah]','',array(
                                'id' => 'Hygienispenerimaanbarang_jumlah_index',
                                'class' => 'form-control',
                            )),
                ),
		array(
                    ...
                    'template'=>'{view} {update}',
                                    'buttons' => array(
                                        'view' =>   array(
                                                       ...
                                                       'url'=>'Yii::app()->createUrl("hygienis/penerimaanbarang/view", array("id"=>$data->id))',
                                                        'options'=>array(
                                        ...
                                        'update' =>   array(
                                                       'label'=>'edit',
                                                       'icon'=>'fa fa-edit',
                                                       'url'=>'Yii::app()->createUrl("hygienis/penerimaanbarang/update", array("id"=>$data->id))',
                                                        'options'=>array(
                                                            'class'=>'btn btn-success btn-xs',
                                                            'ajax'=>array(
                                                                'type'=>'POST',
...
function reinstallDatePicker(id, data) {
    $('#Hygienispenerimaanbarang_tanggal_index').datepicker();
}
");
?>
