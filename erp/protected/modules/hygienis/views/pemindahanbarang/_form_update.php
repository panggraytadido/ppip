<?php   
        $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
                'type'=>'horizontal',
                'id'=>'hygienispemindahanbarang-form',
...
<input type="hidden" id="Hygienispemindahanbarang_id" name="Hygienispemindahanbarang[id]" value="<?php echo $modelPemindahan->id; ?>" />
        ...
        <?php 
            echo $form->datePickerGroup($modelPemindahan, 'tanggal', array(
                                ...
                                'widgetOptions' => array(
                                                        'htmlOptions'=>array(
                                                                'id'=>'Hygienispemindahanbarang_tanggal_input',
                                                                'readonly'=>'readonly',
        ...
        <input type="hidden" id="Hygienispemindahanbarang_barangid" name="Hygienispemindahanbarang[barangid]" value="<?php echo $modelPemindahan->barangid; ?>" />
        <?php   
                echo $form->dropDownListGroup($modelPemindahan, 'barangid',array(
                                    ...
                                    'widgetOptions' => array(
                                            ...
                                            'htmlOptions' => array(
                                                    ...
                                                    'disabled'=>'disabled',
                                                    'name'=>'Hygienispemindahanbarang_barangid_view',
                                            )
                                    )
                                )
                            );
            ...
            array(
                ...
                'success'=>'js:function(data) 
                 {    
                   ...
                   if(data.result==="OK")
                   {  
                        location.href="'.Yii::app()->createUrl("hygienis/pemindahanbarang/view", array("id"=>$modelPemindahan->id)).'";
                        selesai();
                   }
                   else
                   {                        
                       ...
                       {
                           $("#hygienispemindahanbarang-form #"+key+"_em_").text(val);                                                    
                           $("#hygienispemindahanbarang-form #"+key+"_em_").show();
                       });
                   }       
...
<script type="text/javascript">
    ...
    {
        var tgl = document.getElementById("Hygienispemindahanbarang_tanggal_input").value;
        var jumlahAbsen = 0;
        ...
        if(tgl!='')
        {
            $.ajax({
                    type: 'POST',
                    url: '<?php echo Yii::app()->baseurl; ?>/hygienis/pemindahanbarang/getjumlahabsen',
                    data: { tanggal : tgl},
    ...
    function tambahKaryawan()
    {
        ...
        if(tgl!='')
        {
            $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: '<?php echo Yii::app()->baseurl; ?>/hygienis/pemindahanbarang/getkaryawanabsen',
                    data: { tanggal : tgl},
    ...
    {
        var e = document.getElementById("Hygienispemindahanbarang_barangid");
        ...
        if(barangid!='')
        {
            $.ajax({
                        dataType: 'json',
                        type: 'POST',
                        url: '<?php echo Yii::app()->baseurl; ?>/hygienis/pemindahanbarang/getsupplierbarang',
