...
<?php echo $form->errorSummary($modelPenjualan); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="radio" name="Hygienispenjualanbarang[kategori]" id="kategori1" onchange="hitungHargaBarang();" value="1" checked="checked" /> R.Ikan 
                <input type="radio" name="Hygienispenjualanbarang[kategori]" id="kategori2" onchange="hitungHargaBarang();" value="2" /> Grosir 
            </div>
        </div>
...
<div style="float:left">            
    <?php 
        echo CHtml::ajaxSubmitButton('Simpan',CHtml::normalizeUrl(array('penjualanbarang/create','render'=>true)),
            array(
                'dataType'=>'json',
                'type'=>'POST',                      
                'success'=>'js:function(data) 
                 {    
                   ...
                   if(data.result==="OK")
                   {             
                      location.href="'.Yii::app()->baseurl.'/hygienis/penjualanbarang/view/id/" + data.penjualanid;
                   }
