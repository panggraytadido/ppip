...
class FPDF_AutoWrapTable extends FPDF{
 ...
 function FancyTable($header, $data){
	...
	$this->MultiCell(78, 0, 'Perkumpulan Pengolah Ikan Pindang (PPIP)', 0, 0);
	...
	$this->Ln(10);
        ...
        {
            $t = Lappenerimaanbaranggudang::model()->getTotalPenerimaanBarangPerBulan($_GET['pilihan'],$_GET['tahun']);           
        }
  ...
  //Fungsi Untuk Membuat Footer
	function Footer()
	{
        ...
        {
            $data = Lappenerimaanbaranggudang::model()->getPenerimaanBarangPerBulan($_GET['pilihan'],$_GET['tahun']);
        }
