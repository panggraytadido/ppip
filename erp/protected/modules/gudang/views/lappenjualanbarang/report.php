...
class FPDF_AutoWrapTable extends FPDF{
 ...
 function FancyTable($header, $data){
	...
	$this->Ln(10);
        ...
        {
            $t = Lappenjualanbaranggudang::model()->getTotalPenjualanBarangPerBulan($_GET['pilihan'],$_GET['tahun']);           
        }
  ...
  //Fungsi Untuk Membuat Footer
	function Footer()
	{
        ...
        {
            $data = Lappenjualanbaranggudang::model()->getPenjualanBarangPerBulan($_GET['pilihan'],$_GET['tahun']);
        }
