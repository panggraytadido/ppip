...
class FPDF_AutoWrapTable extends FPDF{
 ...
 function FancyTable($header, $data){
	...
	$this->MultiCell(42, 0, 'Perkumpulan Pengolah Ikan Pindang (PPIP)', 0, 0);
	$this->MultiCell(0, 5, '',0);
	$this->Cell(0, 1, " ", "B");
	$this->Ln(5);
	$this->SetFont("", "B", 9);
	$this->Cell(0, 5, 'LAPORAN STOCK UPDATE GUDANG', 0, 0,'C');
	$this->Ln(10);
        ...
        //$data = explode("|", $t);
        $data = Lapstockupdategudang::model()->getStockUpdate();
