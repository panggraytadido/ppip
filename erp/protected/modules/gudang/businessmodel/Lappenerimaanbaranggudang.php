...
class Lappenerimaanbaranggudang extends Penerimaanbarang
{
        public $pilih;
	public $tanggal;
	public $bulan;
        ...
        public static function model($className=__CLASS__)
	{
        ...
        public function getPenerimaanBarangPerBulan($bulan,$tahun)
        {
            $connection=Yii::app()->db;            
            $lokasi = Yii::app()->session['lokasiid'];
            ...
            $sql="SELECT 
                  ...
                  WHERE 
                    ...
                    pb.supplierid = hb.supplierid AND
                    b.id=hb.barangid AND 
                    EXTRACT(MONTH FROM pb.tanggal)='$bulan' and EXTRACT(YEAR FROM pb.tanggal)='$tahun' and pb.lokasipenyimpananbarangid=$lokasi";					
            $data=$connection->createCommand($sql)->queryAll();
            return $data;
        }
        
        public function getTotalPenerimaanBarangPerBulan($bulan,$tahun)
        {
            $connection=Yii::app()->db;            
