            ...
            <?php $this->widget('booster.widgets.TbGridView', array(
                ...
                'columns'=>array(
                    ...
                    array(
                        ...
                        {
                            $divisiid = Userskaryawan::model()->find('usersid='.$data->id)->divisiid;
                            if($divisiid!=0)
                            {
                            //    return Divisi::model()->findByPk($divisiid)->nama;
                            }
                            else
                            {
                                return 'Supplier';
                    ...
                    array(
                        ...
                        'value' => function($data,$row)
                        {
                            $lokasiid = Userskaryawan::model()->find('usersid='.$data->id)->lokasipenyimpananbarangid;
                            if($lokasiid!=0)
                            {
                                //return Lokasipenyimpananbarang::model()->findByPk($lokasiid)->nama;
                            }
                            else
                            {
                                return '-';
                        ...
                        'filter'=>  CHtml::dropDownList('User[lokasi]','nama',
                                    CHtml::listData(Lokasipenyimpananbarang::model()->findAll(),'id','nama'),
                                    array(
                                        'id'=>'User_divisi',
                                        'class'=>"form-control",
                                        'prompt'=>'Pilih Lokasi',
