                ...
                <div class="ibox-content">                          
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input class="form-control" disabled="disabled" value="<?php echo Faktur::model()->find("pelangganid=".intval($pelangganid)." and cast(tanggal as date)='$tanggal' and pembelianke=".$pembelianke)->nofaktur; ?>">                            
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="pull-right">
                         <?php                             
                            echo CHtml::ajaxSubmitButton('Simpan',CHtml::normalizeUrl(array('inbox/simpan','pelangganid'=>$pelangganid,'tanggal'=>$tanggal)),
                                array(
                                    'dataType'=>'json',
                                    'type'=>'POST',                      
                                    'success'=>'js:function(data) 
                                     {    
                                       ...
                                       {                
                                          ...
                                          window.open("'.Yii::app()->baseurl.'/kasir/inbox/cetak/pelangganid/"+data.pelangganid+"/tanggal/"+data.tanggal+"/pembelianke/"+data.pembelianke, "_blank");  
                                          location.href="'.Yii::app()->baseurl.'/kasir/inbox";
                                       }
                                       else
                                       {             
                                           $("#btnSaveCash").prop( "disabled", false);
                                    ...
                                    'beforeSend'=>'function()
                                     {                   
                                        $("#btnSaveCash").prop( "disabled", true);
                                          $("#AjaxLoader").show();

                                     }'
                                ),array('id'=>'btnSaveCash','class'=>'btn btn-primary'));      
                        ?> 
