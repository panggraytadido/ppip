...
class FPDF_AutoWrapTable extends FPDF{
 ...
 function FancyTable($header, $data){
	...
	$this->Cell(120, 0, 'Jl. Tulang Kuning No. 04 RT.02 RW.05', 0, 0,'L');
        ...
        $this->Cell(90, -25, 'Parung, '.$_GET['tanggalcetak'].'', 0, 0,'C');
	...
	$this->Ln(5);
        ...
        $dataku = Datasetoran::model()->detailFormFakturCetak($_GET['pelangganid'],$_GET['tanggalcetak'],$_GET['tanggalpembelian'],$_GET['pembelianke']);
        $hargatotal=array();
		...
		$tanggalcetak = $_GET['tanggalcetak'];
		$tanggalpembelian = $_GET['tanggalpembelian'];
       // $noFaktur =Pelanggan::model()->findByPk($_GET['pelangganid'])->kode."/".$_GET['tanggal'];
        $faktur = Faktur::model()->find("pelangganid=".intval($_GET['pelangganid'])." 
									and cast(tanggalcetak as date)='$tanggalcetak' 
										and cast(tanggal as date)='$tanggalpembelian' 
											and pembelianke=".$_GET['pembelianke']." 
