...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	'columns'=>array(
		...
		array('name'=>'hp','header'=>'HP','value'=>'$data->hp','filter'=>false),	
		   array('name'=>'ispemegangsaham','header'=>'Saham','value'=>function($data,$row){
				if($data->ispemegangsaham==1)
				{
					echo '<i style="font-size: 20px;" class="fa fa-check-circle-o"></i>';
				}
				else 
				{
					echo '<i style="font-size: 20px;" class="fa fa-circle-o"></i>';
				}
			},'filter'=>false),	                
		array(
							                    'header'=>'Action',
							                                                        ...
							                                                        'options'=>array(
							                                                            ...
							                                                            'ajax'=>array(                                                                                                                        
							                                                                ...
							                                                                'success'=>'function(data) {
							                                                            		$("#AjaxLoader").hide();								                                                            									                                                            								                                                        
							                                                            		$("#modal-update-anggota .modal-body").html(data); 
							                                                            		$("#modal-update-anggota").modal();
...
<div class="modal fade bs-example-modal-sm" id="modal-update-anggota" tabindex="-1" role="dialog"  aria-hidden="true">
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
