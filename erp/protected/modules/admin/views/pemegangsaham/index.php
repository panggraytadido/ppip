...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
		...
		array('name'=>'kode','header'=>'Kode Saham','value'=>'$data->kode','filter'=>false),	
		/* array('name'=>'sahamid','header'=>'Pemegang Saham','value'=>'$data->nama'),	 */
                   array('name'=>'anggotaid','value'=>function($data,$row){
                    return Anggota::model()->findByPk($data->anggotaid)->nama;
                   },'header'=>'Pemegang Saham','filter' => CHtml::listData(Anggota::model()->findAll(), 'id', 'nama')),   
		   array('name'=>'hargasaham','header'=>'Harga Saham / Lembar','value'=>'number_format($data->hargasaham)','filter'=>false),	
		array('name'=>'jumlahsaham','header'=>'Jumlah Saham','value'=>'$data->jumlahsaham','filter'=>false),		
		array('name'=>'totalsaham','header'=>'Total Saham ( Harga Saham/Lembar * Jumlah Saham )','value'=>'number_format($data->totalsaham)','filter'=>false),	                              		           
		array(
			'header'=>'Action',
			...
			'template'=>'{update} {delete}',
							'buttons' => array(
								'update' =>   array(
											   ...
											   'url'=>'Yii::app()->createUrl("admin/pemegangsaham/popupupdate", array("id"=>$data->id))', 							                                                       
												'options'=>array(
													...
													'ajax'=>array(                                                                                                                        
														...
														'success'=>'function(data) {
															$("#AjaxLoader").hide();								                                                            									                                                            								                                                        
															$("#modal-update-saham .modal-body").html(data); 
															$("#modal-update-saham").modal();
...
<div class="modal fade bs-example-modal-sm" id="modal-update-saham" tabindex="-1" role="dialog"  aria-hidden="true">
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
