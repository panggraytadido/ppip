...
$this->pageTitle = 'Admin - Lokasi Pabrik';
							                    ...
							                    'template'=>'{update} {delete}',
							                                    'buttons' => array(
							                                        'update' =>   array(
							                                                       ...
							                                                       'url'=>'Yii::app()->createUrl("admin/lokasi/popupupdate", array("id"=>$data->id))', 							                                                       
							                                                        'options'=>array(
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Update Data Lokasi</h4>
        </div>
        <div class="modal-body">
