...
class FPDF_AutoWrapTable extends FPDF{
 ...
 function FancyTable($header, $data){
	...
	$this->SetFont("", "B", 12);
	$this->Image('img/profile_small.png',10,5,0);
	$this->MultiCell(25, 0, $perusahaan->owner, 0, 0);
	$this->MultiCell(0, 5, '',0);
	$this->Cell(0, 1, " ", "B");
	$this->Ln(5);
	$this->SetFont("", "B", 9);
	$this->Cell(0, 5, 'RINCIAN HARGA BARANG GUDANG', 0, 0,'C');
	$this->Ln(10);
  ...
  //Fungsi Untuk Membuat Footer
	function Footer()
	{
        ...
        $header = array('No','Divisi','Supplier','Nama Barang','Harga Grosir','Harga Eceran');
        
		$data = Hargabarang::model()->reportHargaBarangPerDivisi(3);
