...
<div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">       
                    <div style="float:right;"><?php 
                            echo CHtml::ajaxButton('Tambah',CHtml::normalizeUrl(array('karyawan/create')),
                                array(
                                    'type'=>'POST',                      
                                    'url'=>"$(this).attr('href')",
                                    'beforeSend'=>'function()
	...
	'columns'=>array(
		...
		'nama',		
                ...
                array('name'=>'jabatanid','value'=>'$data->jabatan->nama','header'=>'Jabatan','filter' => CHtml::listData(Jabatan::model()->findAll(), 'id', 'nama')),   
                array(
                     'header'=>'Photo',
                    'type' => 'raw',
                    'value'=>function($data,$row){
                        if($data->photo!="")
                        {
                            return CHtml::image(Yii::app()->baseUrl . "/../upload/" . $data->photo,"",array("style"=>"width:50px;height:50px;"));
                        }
                        else
                        {
                            return 'tidak ada photo';
                        }
                    }                                                               
                ),               
		array(
