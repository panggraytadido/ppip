            ...
            array(
                ...
                'success'=>'js:function(data) 
                 {    
                   ...
                   {          
					  $("#btnSimpanTransferLain").prop( "disabled", false);
                ...
                'beforeSend'=>'function()
                 {      
					  $("#btnSimpanTransferLain").prop( "disabled", true);	
					  //$("body").undelegate("#btnSimpanTransferLain","click");
                      document.getElementById("loadingProses").style.visibility = "visible";

                 }'
            ),array('id'=>'btnSimpanTransferLain','class'=>'btn btn-primary'));
    ?> 
</div>
...
function getNorek()
{
    ...
    $.ajax({
            dataType: 'json',
            type: 'POST',
            url: '<?php echo Yii::app()->baseurl; ?>/admin/transferlain/getnorek',
            data: data,
