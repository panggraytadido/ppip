...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
		...
		array(
                ...
                array('name'=>'nofaktur','value'=>'$data->nofaktur','header'=>'No Faktur','filter'=>true),	        
                array('name'=>'f.tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal',
                        'filter'=>  $this->widget(
                ...
                array('name'=>'f.pelanggan','value'=>'$data->pelanggan','header'=>'Pelanggan'),	
                array(
