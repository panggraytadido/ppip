	...
	*/
                           ...
                           $model->attributes=$_POST['Kantor'];
                            if($model->save()) 
                            {
                                ...
                                (
                                 ...
                                 Yii::app ()->user->setFlash ( 'success', "Data Kantor Berhasil diTambahkan" );
                                Yii::app()->end();
                            }
                    }
                    else
	...
	public function actionUpdate($id)
	{
		...
		$model=Kantor::model()->findByPk($id);
                $model->nama=$_POST["Kantor"]["nama"]; 
                $model->alamat=$_POST["Kantor"]["alamat"]; 
                $model->email=$_POST["Kantor"]["email"]; 
                $model->telp=$_POST["Kantor"]["telp"]; 
                $model->website=$_POST["Kantor"]["website"]; 
                if($model->save())
                {
                    echo CJSON::encode(array
                    (
                    ...
                    Yii::app ()->user->setFlash ( 'success', "Data Kantor Berhasil diUpdate" );
                    Yii::app()->end();
                }
            }   
	}
