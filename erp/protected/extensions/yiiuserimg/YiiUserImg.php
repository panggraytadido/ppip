...
class YiiUserImg extends CWidget
{
    ...
    public function getImageUrl()
    {
        ...
        $defaultimgbaseurl = Yii::app()->baseUrl.'/images/default.png'; //Path to your default image location and image name!
        $imgbaseurl = Yii::app()->baseUrl.'/'; 
        //$userimg = Yii::app()->baseUrl.'/' .$userObject->filename;  //Renders the current user's image path.  Filename is what I call my file path in my Users Model.  It can be called anything just make sure you chage it everywhere.
        $imageLink = isset($userObject->filename) ? Yii::app()->baseUrl.'/' .$userObject->filename : $defaultimgbaseurl;
        /*
