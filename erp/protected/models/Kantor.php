...
/**
 * This is the model class for table "master.kantor".
 *
 * The followings are the available columns in table 'master.kantor':
 * @property integer $id
...
class Kantor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nama, alamat, telp, email, website', 'safe', 'on'=>'search'),
		);
	}
