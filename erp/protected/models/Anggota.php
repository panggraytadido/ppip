 ...
 * @property integer $ispemegangsaham
...
class Anggota extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama, jeniskelamin, noktp, tanggalbermitra,kode', 'required'),
			array('jeniskelamin, hp, telepon, status,ispemegangsaham', 'numerical', 'integerOnly'=>true),
			...
			array('id, nama, jeniskelamin, alamat, hp, telepon, noktp,  status,ispemegangsaham, tanggalbermitra, pendidikan, kode', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pemegangsahams' => array(self::HAS_MANY, 'Pemegangsaham', 'anggotaid'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'kode' => 'Kode',
			'ispemegangsaham' => 'sebagai pemegang saham',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ispemegangsaham',$this->ispemegangsaham);
