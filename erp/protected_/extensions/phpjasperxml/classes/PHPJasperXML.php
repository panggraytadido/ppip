...
//Yii::import('application.extensions.phpjasperxml.classes.PHPJasperXMLSubReport');

//version 0.9d
class PHPJasperXML extends CApplicationComponent{
	public $db_host;
	public $db_user;
	public $db_pass;
	public $db_or_dsn_name;
        public $insubReport;
        public $subdataset;
        public $group_pointer;
	public $cndriver;
	...
	public $maxpagey;
	public $orititleheight;
	public $currentrow;
	public $prepare_print_array;
	public $titlesummary;
        ...
        public $MainPageCurrentY;
        public $SubReportCheckPoint;
        public $maxy;
        public $arrayMainPageSetting;
        public $subreportParameterExpression;
...
//                     $out["target"]= $this->analyse_expression( $out['target'], true);
    ...
    public function outpage($out_method="I",$filename="") {
            ...
            {                                                         
                include dirname(__FILE__)."/ExportXLS.php";
