...
<script>
    ...
    {      
        ...
        $.ajax({
                dataType: 'json',
                type: 'POST',
                url: '<?php echo Yii::app()->baseurl; ?>/keuangan/slipgajikaryawanharian/checkprint',
                data: data,
                success: function (data) {                                                                          
                 window.open("<?php echo Yii::app()->baseurl ?>/keuangan/slipgajikaryawanharian/print/karyawanid/"+data.karyawanid+"/tahun/"+data.tahun+"/bulan/"+data.bulan);
