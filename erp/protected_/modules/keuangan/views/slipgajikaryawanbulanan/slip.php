<?php
$this->pageTitle = "Laporan - Slip Gaji Karyawan Bulanan";
        ...
        <div class="col-lg-6">                     
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="pull-left">
                        <b>Slip Gaji Karyawan Bulanan</b>
                    </div>
                </div>                
...
<script>
    ...
    {      
        ...
        $.ajax({
                dataType: 'json',
                type: 'POST',
                url: '<?php echo Yii::app()->baseurl; ?>/keuangan/slipgajikaryawanbulanan/checkprint',
                data: data,
                success: function (data) {                                                                          
                 window.open("<?php echo Yii::app()->baseurl ?>/keuangan/slipgajikaryawanbulanan/print/karyawanid/"+data.karyawanid+"/tahun/"+data.tahun+"/bulan/"+data.bulan);
                   location.href= "<?php echo Yii::app()->baseurl ?>/keuangan/slipgajikaryawanbulanan";
                },
                error: function () {
