...
class SlipgajikaryawansopirController extends Controller
{
	public $layout='//layouts/column2';
        public $pageTitle = 'Keuangan - Slip Gaji Karyawan Sopir';
	...
	public function filters()
	{
        ...
        public function actionIndex()
        {
            ...
            {       
                ...
                //total gaji
                $sql ="select sum(upah) as upah from transaksi.perjalanan where EXTRACT(MONTH FROM tanggal) =$bulan and EXTRACT(YEAR FROM tanggal)=$tahun and karyawanid=".$karyawanid;            
        ...
        public function actionCheckPrint()
        {
            ...
            {                
                ...
                try{
                    $bulan = $_POST['bulan'];
                    $model = Gajikaryawansopir::model()->find("tahun=".$_POST['tahun']." AND bulan='$bulan' AND karyawanid=".$_POST['karyawanid']);                     
                    if(count($model)!=0)
                    {
        ...
        {
            echo Yii::app()->Report->Export("gajikaryawansopir.jrxml","Gaji Pegawai",array(
        ...
        {
            if(isset($_POST['ajax']) && $_POST['ajax']==='slipgajikaryawansopir-form')
            {
