                ...
                <div class="ibox-content">                          
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input class="form-control" disabled="disabled" value="<?php echo Faktursupplier::model()->find("supplierpembeliid=".intval($supplierpembeliid)." and cast(tanggal as date)='$tanggal' and pembelianke=".$pembelianke)->nofaktur; ?>">                            
                            </div>
                        </div>
                        <div class="form-group">
