...
<?php   $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <?php     
                echo $form->select2Group($model, 'divisiid',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'),'widgetOptions' => array(
	...
	<div style="float:left">
		...
		<?php 
                echo CHtml::ajaxSubmitButton('Simpan',CHtml::normalizeUrl(array('databarang/create')),
             array(
                 'dataType'=>'json',
                 'type'=>'POST',                      
