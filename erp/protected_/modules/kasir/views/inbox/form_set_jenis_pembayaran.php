...
?>
                    ...
                    <div class="pull-left">
						<button class="btn btn-primary" onclick="pilihan();">Submit</button>						
                         <?php 
							/*
...
function pilihan()
{
	...
	var data = 'pilihan='+pilihan+'&pelangganid='+pelangganid+'&tanggal='+tanggal;
	if(pilihan!=0)
	{
		if(pelangganid!='' && tanggal!='')
		{
			 $.ajax({
					...
					success: function (row) {   
						...
						if(row.result=="INBOX")
						{
							location.href="<?php echo Yii::app()->baseurl; ?>/kasir/inbox/formfaktur/pelangganid/"+row.pelangganid+"/tanggal/"+row.tanggal;
						}		
