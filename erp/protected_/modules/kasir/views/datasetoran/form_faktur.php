                ...
                <div class="ibox-content">                          
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                            <input class="form-control" disabled="disabled" value="<?php echo Faktur::model()->find("pelangganid=".$pelangganid." AND cast(tanggal as date)='$tanggal' AND pembelianke=".$pembelianke)->nofaktur; ?>">
                            </div>
                        </div>
                        <div class="form-group">
               ...
               // 'action'=>Yii::app()->createAbsoluteUrl("oemmkt/manajemencustomer/Ajaxvalidatecustomerprofile"),//Yii::app()->createUrl($this->route),
        		...
        		'clientOptions'=>array(
                    ...
                    <div class="pull-right">
                         <?php 
                            echo CHtml::ajaxSubmitButton('Simpan',CHtml::normalizeUrl(array('datasetoran/simpan','pelangganid'=>$pelangganid,'tanggal'=>$tanggal)),
                                array(
                                    'dataType'=>'json',
                                    'type'=>'POST',                      
