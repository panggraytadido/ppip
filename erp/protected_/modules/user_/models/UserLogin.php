...
class UserLogin extends CFormModel
{
	...
	public function attributeLabels()
	{
		return array(
           ...
           // 'deptid'=>UserModule::t("Departemen"),
    ...
    /*    
    public function authdept($attribute,$params)
    {
        $hasuserdept = UserDept::model()->countByAttributes(array('username'=>$this->username, 'departemenid'=>$this->deptid));
		
        if($hasuserdept)
            Yii::app()->session['deptid'] = $this->deptid;
        else
            $this->addError($attribute, 'You don\'t have access!');
    }
