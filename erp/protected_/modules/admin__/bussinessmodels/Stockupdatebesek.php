...
class Stockupdatebesek extends Stocksupplier
{
    public $kode;
    public $nama;
    public $hargamodal;
    ...
    public function listStockUpdate()
    {
		...
		$criteria=new CDbCriteria;
                ...
                {                                        
                    if($_GET['Stockupdatebesek']['barang']!='')                                            
                     $criteria->compare('upper(b.nama)',  strtoupper($_GET['Stockupdatebesek']['barang']),true);                     
                }
		...
		return new CActiveDataProvider('Stockupdatebesek', array(
			'criteria'=>$criteria,
                        'sort'=>$sort,
                        'pagination'=>array(
							'pageSize'=>10,
