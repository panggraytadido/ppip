...
class Penerimaanbarangbesek extends Penerimaanbarang
{
    //public $tanggal;
    public $nama;
    public $divisiid;
    ...
    public function listBarang()
    {
        ...
        {
                    if($_GET['Penerimaanbarangbesek']['supplierid']!='')
                    ...
                    if($_GET['Penerimaanbarangbesek']['tanggal']!='')
                        $criteria->compare('tanggal', date("Y-m-d", strtotime($_GET['Penerimaanbarangbesek']['tanggal'])));
        }
    ...
    public function grafikPenerimaanBarangBesek()
    {
        $tahun = date('Y');
         $divisiid = Divisi::model()->find("kode='2'")->id;
