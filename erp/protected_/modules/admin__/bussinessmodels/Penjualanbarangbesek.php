...
class Penjualanbarangbesek extends Penjualanbarang
{          
    ...
    public function listBarang()
    {
        ...
        {
                    if($_GET['Penjualanbarangbesek']['pelangganid']!='')
                    ...
                    if($_GET['Penjualanbarangbesek']['tanggal']!='')
                        $criteria->compare('pb.tanggal', date("Y-m-d", strtotime($_GET['Penjualanbarangbesek']['tanggal'])));
        }
