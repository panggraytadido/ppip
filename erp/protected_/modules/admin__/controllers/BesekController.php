...
class BesekController extends Controller
{
	...
	{
            $modelStockupdate = new Stockupdatebesek('search');        
              $modelStockupdate->unsetAttributes();
            if(isset($_GET['Stockupdatebesek']))
                    $modelStockupdate->attributes=$_GET['Stockupdatebesek'];
            
           //print("<pre>".print_r($modelStockupdate->listStockUpdate(),true)."</pre>");	
            //die;
            
            //penerimaan barang             
            $modelPenerimaanBarangBesek = new Penerimaanbarangbesek('search');            
            $modelPenerimaanBarangBesek->unsetAttributes();
            if(isset($_GET['Penerimaanbarangbesek']))
                    $modelPenerimaanBarangBesek->attributes=$_GET['Penerimaanbarangbesek'];
            //end 
            
            
            
            //penjualan barang
            $modelPenjualanBarang = new Penjualanbarangbesek('search');
            $modelPenjualanBarang->unsetAttributes();
            if(isset($_GET['Penjualanbarangbesek']))
                    $modelPenjualanBarang->attributes=$_GET['Penjualanbarangbesek'];
            //
            ...
            $this->render('index',
                    array(
                        ...
                        'modelPenerimaanBarangBesek'=>$modelPenerimaanBarangBesek,
                        'modelPenjualanBarang'=>$modelPenjualanBarang,
