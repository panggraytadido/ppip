...
class JabatanController extends Controller
{
                           ...
                           $model->attributes=$_POST['Jabatan'];
                            if($model->save()) 
                            {
                                ...
                                (
                                 ...
                                 Yii::app ()->user->setFlash ( 'success', "Data Jabatan Berhasil diTambahkan" );
                                Yii::app()->end();
                            }
                    }
                    else
	...
	public function actionUpdate($id)
	{
		...
		$model=  Jabatan::model()->findByPk($id);                
                $model->kode=$_POST["Jabatan"]["kode"]; 
                $model->nama=$_POST["Jabatan"]["nama"];
                $model->keterangan=$_POST["Jabatan"]["keterangan"];
                if($model->save())
                {
                    echo CJSON::encode(array
                    (
                    ...
                    Yii::app ()->user->setFlash ( 'success', "Data Jabatan Berhasil diUpdate" );
                    Yii::app()->end();
                }
            }
	}
