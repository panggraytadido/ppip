...
class PropinsiController extends Controller
{
                           ...
                           $model->attributes=$_POST['Propinsi'];
                            if($model->save()) 
                            {
                                ...
                                (
                                 ...
                                 Yii::app ()->user->setFlash ( 'success', "Data Propinsi Berhasil diTambahkan" );
                                Yii::app()->end();
                            }
                    }
                    else
	...
	public function actionUpdate($id)
	{
		...
		$model=  Propinsi::model()->findByPk($id);                
                $model->kode=$_POST["Propinsi"]["kode"]; 
                $model->nama=$_POST["Propinsi"]["nama"];                
                if($model->save())
                {
                    echo CJSON::encode(array
                    (
                    ...
                    Yii::app ()->user->setFlash ( 'success', "Data Propinsi Berhasil diUpdate" );
                    Yii::app()->end();
                }
            }
	}
