...
class KotaController extends Controller
{
                           ...
                           $model->attributes=$_POST['Kota'];
                            if($model->save()) 
                            {
                                ...
                                (
                                 ...
                                 Yii::app ()->user->setFlash ( 'success', "Data Kota Berhasil diTambahkan" );
                                Yii::app()->end();
                            }
                    }
                    else
	...
	public function actionUpdate($id)
	{
		...
		$model=Kota::model()->findByPk($id);
                $model->propinsiid=$_POST["Kota"]["propinsiid"]; 
                $model->kode=$_POST["Kota"]["kode"]; 
                $model->nama=$_POST["Kota"]["nama"];                 
                if($model->save())
                {
                    echo CJSON::encode(array
                    (
                    ...
                    Yii::app ()->user->setFlash ( 'success', "Data Kota Berhasil diUpdate" );
                    Yii::app()->end();
                }
            }   
	}
