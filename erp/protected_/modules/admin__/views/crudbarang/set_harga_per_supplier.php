                   ...
                   <div class="form-group">
					...
					for($i=0;$i<count($data);$i++)
                            ...
                            <td>
                                ...
                                <input class="form-control" id="hargamodal_1" name="hargamodal[1]" value='0' >
                            </td>
                            <td>
                                <input type="hidden" name="cekhargaeceran" id="cekhargaeceran_1">
                                <input class="form-control" id="hargaeceran_1" name="hargaeceran[1]" value='0' >
                            ...
                            <td>
                                ...
                                <input class="form-control" id="hargagrosir_1" name="hargagrosir[1]" value='0'>
...
{    
	...
	rowAdded += '<input class="form-control"  id="hargamodal_'+maxNo+'" name="hargamodal['+maxNo+']" value="0">';				
	rowAdded += '</td>';
		
	rowAdded += '<td>';
        rowAdded += '<input type="hidden" class="form-control" id="cekhargaeceran_'+maxNo+'">';
	rowAdded += '<input class="form-control" id="hargaeceran_'+maxNo+'"   name="hargaeceran['+maxNo+']" value="0">';
	...
	rowAdded += '<input class="form-control" id="hargagrosir_'+maxNo+'"  name="hargagrosir['+maxNo+']" value="0">';	
