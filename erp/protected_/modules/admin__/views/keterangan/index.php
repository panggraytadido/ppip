							                    ...
							                    'template'=>'{update} {delete}',
							                                    'buttons' => array(
							                                        'update' =>   array(
							                                                       ...
							                                                       'url'=>'Yii::app()->createUrl("admin/keterangan/popupupdate", array("id"=>$data->id))', 							                                                       
							                                                        'options'=>array(
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Tambah Data Keterangan</h4>
        </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Update Data Keterangan</h4>
        </div>
        <div class="modal-body">
        <div id="AjaxLoader" style="display: none"><img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/inspinia/img/loader.gif"></img></div>           
           <br>    
