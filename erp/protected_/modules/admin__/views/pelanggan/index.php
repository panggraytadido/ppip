...
$this->pageTitle = 'Admin - Pelanggan';
        ...
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                <div class="ibox-content">           
                    <div style="float:right;"><a href="" class="btn btn-info btn-xs"><i class="fa fa-refresh"></i> Refresh</a> &nbsp;<button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal-bagian"><i class="fa fa-plus"></i>Tambah</button></div>
