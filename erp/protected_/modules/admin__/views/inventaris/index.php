...
$this->pageTitle = 'Admin - Inventaris';
...
<?php $this->widget('booster.widgets.TbGridView', array(
	...
	'columns'=>array(
		...
		array('header'=>'Bagian','name'=>'bagianid','value'=>'$data->bagian->nama'),
		'kode',		
		'hargasatuan',
		array(
							                    'header'=>'Action',
							                    ...
							                    'template'=>'{update} {delete}',
							                                    'buttons' => array(
							                                        'update' =>   array(
							                                                       ...
							                                                       'url'=>'Yii::app()->createUrl("admin/inventaris/popupupdate", array("id"=>$data->id))', 							                                                       
							                                                        'options'=>array(
