...
<?php   $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldGroup($model, 'nama',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'))); ?> 
        ...
        <?php     
                echo $form->dropDownListGroup($model, 'jeniskelamin',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'),'widgetOptions' => array(
       ...
       <?php echo $form->datePickerGroup($model, 'tanggallahir',array('wrapperHtmlOptions'=>array('class'=>'col-sm-5'))); ?>  
       
       <?php echo $form->textAreaGroup($model, 'alamat',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'))); ?> 

       <?php     
                echo $form->dropDownListGroup($model, 'jeniskaryawanid',array('wrapperHtmlOptions'=>array('class'=>'col-sm-3'),'widgetOptions' => array(
                                            'data' => array('1'=>'Tetap','2'=>'Kontrak'),
                                            'htmlOptions' => array(
       ...
       <?php     
                echo $form->dropDownListGroup($model, 'pendidikan',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'),'widgetOptions' => array(
       ...
       ?> 
        ...
        <?php     
                echo $form->dropDownListGroup($model, 'jabatanid',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'),'widgetOptions' => array(
        ...
        <?php echo $form->datePickerGroup($model, 'tmtmasuk',array('wrapperHtmlOptions'=>array('class'=>'col-sm-5'))); ?>
            ...
            <label class="col-sm-5 control-label" for="Karyawan_tmtmasuk">Photo</label>
                <div class="col-sm-5 col-sm-9">
                    ...
                    <div>
                            ...
                            <?php echo $form->fileField($model,'photo',array('size'=>60,'maxlength'=>200,'onchange'=>'readURL(this);')); ?>
		...
		<?php 
                echo CHtml::ajaxSubmitButton('Simpan',CHtml::normalizeUrl(array('karyawan/create','render'=>true)),
             array(
                 'dataType'=>'json',
                 'type'=>'POST',                      
                 'success'=>'js:function(data) 
                  {                   
                    ...
                    if(data.result==="OK")
                    {             
                       var karyawanid =  $("#karyawanidhidden").val(data.karyawanid);
                       if(karyawanid)
                       {
                            upload_file();
                       }
...
<script type="text/javascript">
	...
	var karyawanid = $('#karyawanidhidden').val();
	if(karyawanid!='')
	{
            var fd = new FormData();  
            ...
            fd.append("karyawanidhidden",$("#karyawanidhidden").val());
	    
	    $.ajax({
	        url: '<?php echo Yii::app()->createAbsoluteUrl("admin/karyawan/uploadfile"); ?>',
	        type: 'POST',
	        cache: false,
	        data: fd,
	        processData: false,
