...
class Rinciansetoran extends Setoran
{       
    public $nofaktur;
    public $pelanggan;    
    public $jumlah;
    ...
    public function listDataSetoran($tanggal)
    {
        ...
        $criteria->condition="cast(s.tanggalsetoran as date)='$tanggal' and s.jenisbayar='setoran'";
        $data = Rinciansetoran::model()->findAll($criteria);
        return $data;
    }
