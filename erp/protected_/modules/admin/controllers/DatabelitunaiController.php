        ...
        if(isset($_POST['Databelitunai']))
        {
            ...
            {  
				...
				try{
					...
					$tanggal = Yii::app()->DateConvert->ConvertTanggal($_POST['Databelitunai']['tanggal']);
					$keuanganHarian = Pencatatankeuanganharian::model()->find("cast(tanggal as date)='$tanggal'");
					
					$model->pencatatankeuanganharianid=$keuanganHarian->id;
					...
					if($model->save())
					{
						$keuanganHarian->jumlah = $keuanganHarian->jumlah-$_POST['Databelitunai']['total'];
						$keuanganHarian->totalkeuanganharian = $keuanganHarian->totalkeuanganharian-$_POST['Databelitunai']['total'];
