	...
	<?php echo $form->textFieldGroup($model, 'nama',array('wrapperHtmlOptions'=>array('class'=>'col-sm-8'))); ?> 
      ...
      <?php echo $form->datePickerGroup($model, 'tanggalbermitra',array('wrapperHtmlOptions'=>array('class'=>'col-sm-5'))); ?>
	   ...
	   <?php echo $form->textFieldGroup($model, 'telepon',array('wrapperHtmlOptions'=>array('class'=>'col-sm-4'))); ?> 
        ...
        <input type="hidden" name="anggotaidhidden" id="anggotaidhidden" value=15/>;
             ...
             array(
                 ...
                 'success'=>'js:function(data) 
                  {                   
                    ...
                    if(data.result==="OK")
                    {             
                       var anggotaid =  $("#anggotaidhidden").val(data.anggotaid);
                       if(anggotaid)
                       {
                            upload_file();
                       }
...
<script type="text/javascript">
	...
	if(anggotaid!='')
	{
	    ...
	    $.ajax({
	        url: '<?php echo Yii::app()->createAbsoluteUrl("admin/anggota/uploadfile"); ?>',
	        type: 'POST',
	        cache: false,
	        data: fd,
	        processData: false,
