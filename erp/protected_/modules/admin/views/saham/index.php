...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">       
                    <div style="float:right;"><?php 
                            echo CHtml::ajaxButton('Tambah',CHtml::normalizeUrl(array('saham/create')),
                                array(
                                    'type'=>'POST',                      
                                    'url'=>"$(this).attr('href')",
                                    'beforeSend'=>'function()
		...
		array('name'=>'tanggalpenetapan','value'=>'date("d-m-Y", strtotime($data->tanggalpenetapan))','header'=>'Tanggal Penetapan'),	
			...
			'template'=>'{update}',
							'buttons' => array(
								'update' =>   array(
											   ...
											   'url'=>'Yii::app()->createUrl("admin/saham/popupupdate", array("id"=>$data->id))', 							                                                       
												'options'=>array(
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Tambah Data Saham</h4>
        </div>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Update Data Saham</h4>            
        </div>
