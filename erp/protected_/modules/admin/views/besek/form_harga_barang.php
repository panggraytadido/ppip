            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php 
                            echo CHtml::ajaxSubmitButton('Cetak',CHtml::normalizeUrl(array('besek/formhargabarang')),
                                array(
                                    'dataType'=>'json',
                                    'type'=>'POST',                      
                                    'success'=>'js:function(data) 
                                     {    
                                       ...
                                       {          
                                          ...
                                          {
												window.open("'.Yii::app()->baseurl.'/admin/besek/cetak/jenisharga/" + data.jenisharga, "_blank");                                                  
                                          }
