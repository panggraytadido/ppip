...
$this->pageTitle = 'Admin - Divisi Besek';
...
<div class="row">
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                $this->renderPartial('penerimaanbarang/grid_penerimaan_barang',
                                    array(                                                            
    ...
    <div id="tab-2" class="tab-pane">
        <div class="panel-body">
            ...
            $this->renderPartial('penjualanbarang/grid_penjualan_barang',
                                    array(
    ...
    <div id="tab-3" class="tab-pane">
        <div class="panel-body">
            ...
            $this->renderPartial('grid_stock_update',
                                    array(
	...
	<div id="tab-4" class="tab-pane">
        <div class="panel-body">
            ...
            $this->renderPartial('form_harga_barang'                                 
                                ); 
