                ...
                <div class="ibox-content">
                       <?php $this->widget('booster.widgets.TbGridView', array(
                            ...
                            'columns'=>array(
                                    ...
                                    array('name'=>'tanggal','value'=>'date("d-m-Y", strtotime($data->tanggal))','header'=>'Tanggal Faktur',
                                            'filter'=>  $this->widget(
                                                'booster.widgets.TbDatePicker',
                                                array(
                                                    'name' => 'Datafaktur1[tanggal]',
                                                    'attribute' => 'tanggal',
                                                    'htmlOptions' => array(
                                                                        'id' => 'Datafaktur1_tanggal_index',
...
function reinstallDatePicker(id, data) {
    $('#Datafaktur1_tanggal_index').datepicker();
}
");
?>
