...
$this->pageTitle = "Data Barang - Admin";
            ...
            <div class="ibox float-e-margins">
                 <div class="ibox-title">
                    ...
                    <div class="pull-right">
                        ...
                        <?php 
                            echo CHtml::ajaxButton('Tambah',CHtml::normalizeUrl(array('crudbarang/create')),
                                array(
                                    'type'=>'POST',                      
                                    'url'=>"$(this).attr('href')",
                                    'beforeSend'=>'function()
                ...
                <?php $this->widget('booster.widgets.TbGridView', array(
                                    ...
                                    'columns'=>array(
                                         ...
                                         array(
                                            ...
                                            'url' =>$this->createUrl("crudbarang/detailbarang"),
                                            ...
                                            array('name'=>'divisi','value'=>'$data->divisi','header'=>'Divisi','filter'=>  CHtml::dropDownList('Crudbarang[divisi]','nama',
                                    CHtml::listData(Divisi::model()->findAll("kode='1' OR kode='5' OR kode='3'"),'id','nama'),
                                    array(
                                        'id'=>'User_divisi',
                                        'class'=>"form-control",
                                        'prompt'=>'Pilih Divisi',
