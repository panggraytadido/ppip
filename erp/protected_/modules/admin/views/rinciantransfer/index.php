<?php
$this->pageTitle = "Laporan - Rincian Transfer";
            ...
            <div class="ibox float-e-margins">
                ...
                //		'method'=>'post',
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php 
                            echo CHtml::ajaxSubmitButton('Cetak',CHtml::normalizeUrl(array('rinciantransfer/submit')),
                                array(
                                    'dataType'=>'json',
                                    'type'=>'POST',                      
                                    'success'=>'js:function(data) 
                                     {    
                                       if(data.result==="OK")
                                       {          
                                          window.open("'.Yii::app()->baseurl.'/admin/rinciantransfer/cetak/tanggal/"+data.tanggal, "_blank");  
                                       }
									   else if(data.result==="False")
									   {
										  $("#AjaxLoader").hide();
										   location.href="'.Yii::app()->baseurl.'/admin/rinciantransfer";                                         
									   }
                                       else
                                       {                        
