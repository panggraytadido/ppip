...
class AdminController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $usersauthassignment = new UserAuthassignment;
        ...
        if(isset($_POST['User']) && isset($_POST['Profile']))
        {
            ...
            if($model->validate() && $profile->validate() && $userskaryawan->validate())
            {
                ...
                if($model->save()) 
                {
                    ...
                    $usersauthassignment->itemname=divisi::model()->findByPk($_POST['Userskaryawan']['divisiid'])->nama;
                    $usersauthassignment->userid=$model->id;
                    if($usersauthassignment->save())
                    {
    ...
    public function actionDelete()
    {
        if(Yii::app()->request->isPostRequest)
        {
            ...
            $id = $model->id;
            $userasuthassignment = UserAuthassignment::model()->find("userid='$id'");
            $userasuthassignment->delete();
