...
<div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                ...
                <center> <img alt="image" class="img-circle animated rotateIn" src="<?php echo Yii::app()->request->baseUrl; ?>/img/logoppip.jpg" /></center>

            </div>
            <h3>Authentikasi User</h3>
            <p>ERP Sistem PPIP
                <!--Continually expanded and constantly improved Inspinia Admin Them (IN+)-->
            </p>
            <p>Penyalur Ikan Pindang dan Frozen Fish </p>
