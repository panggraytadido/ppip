...
<?php echo $form->errorSummary($modelPenjualan); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="radio" name="Gudangpenjualanbarang[kategori]" id="kategori1" onchange="hitungHargaBarang();" value="1" checked="checked" /> Eceran 
                <input type="radio" name="Gudangpenjualanbarang[kategori]" id="kategori2" onchange="hitungHargaBarang();" value="2" /> Grosir 
            </div>
        </div>
            ...
            array(
                ...
                'success'=>'js:function(data) 
                 {    
                   ...
                   if(data.result==="OK")
                   {             
                      location.href="'.Yii::app()->baseurl.'/gudang/penjualanbarang/view/id/" + data.penjualanid;
                   }
...
<script type="text/javascript">
    ...
    function cekStock()
    {
        ...
        var barangid = document.getElementById("Gudangpenjualanbarang_barangid").value;        

        var lokasiid = document.getElementById("Gudangpenjualanbarang_lokasipenyimpananbarangid").value;
        
        var supplierid = document.getElementById("Gudangpenjualanbarang_supplierid").value;        
    ...
    function addKaryawan()
    {
        ...
        if(tgl!='')
        {
            $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: '<?php echo Yii::app()->baseurl; ?>/gudang/penjualanbarang/getkaryawanabsen',
                    data: { tanggal : tgl},
                    success: function (data) {
