...
$this->pageTitle = "Laporan Stock Update - Gudang";
        ...
        <div class="col-lg-12">                     
            <div class="ibox float-e-margins">
                 <div class="ibox-title">
                    <div class="pull-left">
                        <b>Gudang - Stock Update Barang</b>
                    </div>                   
                </div>
             ...
             array(
                 ...
                 'success'=>'js:function(data) 
                  {                                                     
                    if(data.result==="OK")
                    {             
                        //location.href="'.Yii::app()->baseurl.'/gudang/lapstockupdate/print";    	
window.open("'.Yii::app()->baseurl.'/gudang/lapstockupdate/print" , "_blank"); 						
                    }                  
                    else
                    {                        
...
function active()
{
    var option = $('#Lappenerimaanbarang_pilih option:selected').val();    
    if(option==1)
    {
        $('#tanggal').show();    
        $('#bulan').hide();    
...
function clearErr()
{
    $('#Lappenerimaanbarang_pilih_em_').empty();
}
</script>