...
/**
 * This is the model class for table "report.gajikaryawangudang".
 *
 * The followings are the available columns in table 'report.gajikaryawangudang':
 * @property string $id
 ...
 */
class Gajikaryawangudang extends CActiveRecord
{
	/**
	...
	{
		return 'report.gajikaryawangudang';
	}
	...
	public function rules()
	{
		...
		return array(
			array('tahun, bulan, totalgaji, totalkasbon, totalbayarkasbon, sisakasbon, uangmakan, uangtransport, insentive, bonus, karyawanid, userid, gaji', 'numerical', 'integerOnly'=>true),
			array('tanggal, createddate, updateddate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tahun, bulan, tanggal, totalgaji, totalkasbon, totalbayarkasbon, sisakasbon, uangmakan, uangtransport, insentive, bonus, karyawanid, createddate, updateddate, userid, gaji', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Gajikaryawangudang the static model class
	 */
