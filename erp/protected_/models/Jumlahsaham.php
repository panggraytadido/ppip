...
class Jumlahsaham extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('jumlahsaham, nama', 'required'),
			array('anggotaid, sahamid', 'numerical', 'integerOnly'=>true),
			array('createddate, updateddate', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, anggotaid, sahamid, createddate, updateddate,jumlahsaham,nama, userid', 'safe', 'on'=>'search'),
		);
	}
