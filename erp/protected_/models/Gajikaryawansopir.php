...
/**
 * This is the model class for table "report.gajikaryawansopir".
 *
 * The followings are the available columns in table 'report.gajikaryawansopir':
 * @property string $id
 ...
 */
class Gajikaryawansopir extends CActiveRecord
{
	/**
	...
	{
		return 'report.gajikaryawansopir';
	}
	 ...
	 * @return Gajikaryawansopir the static model class
	 */
