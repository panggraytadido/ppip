...
/**
 * This is the model class for table "master.bagian".
 *
 * The followings are the available columns in table 'master.bagian':
 * @property integer $id
...
class Bagian extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, divisiid, kode, nama, keterangan', 'safe', 'on'=>'search'),
		);
	}
