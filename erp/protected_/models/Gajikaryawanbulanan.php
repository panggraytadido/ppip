...
/**
 * This is the model class for table "report.gajikaryawanbulanan".
 *
 * The followings are the available columns in table 'report.gajikaryawanbulanan':
 * @property string $id
 ...
 */
class Gajikaryawanbulanan extends CActiveRecord
{
	/**
	...
	{
		return 'report.gajikaryawanbulanan';
	}
	 ...
	 * @return Gajikaryawanbulanan the static model class
	 */
